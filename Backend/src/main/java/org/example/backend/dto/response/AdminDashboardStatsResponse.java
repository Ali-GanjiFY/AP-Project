...
/**
 * Represents admin dashboard stats response.
 */
public class AdminDashboardStatsResponse {
    ...
    /**
     * Constructs a new AdminDashboardStatsResponse.
     ...
     */
    public AdminDashboardStatsResponse(long usersCount,
                                       long advertisementsCount,
                                       long adminReviewsCount,
                                       long pendingAdvertisementsCount) {
